...
public class HospitalManagement {
	...
	private void initialize() {
		...
		aptmtInputPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 5), "Add Appointment",
		...
		btnaddAppointment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(aptmtInputPanel, "Please enter an Valid ID", "Invalid ID",
		...
		prescriptionInputPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 5), "Add Prescription",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnaddPresc.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					e1.printStackTrace();
					JOptionPane.showMessageDialog(prescriptionInputPanel, "Please enter an Valid ID", "Invalid ID",
							JOptionPane.ERROR_MESSAGE);
		...
		medicInputPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 5), "Add Medications",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnaddMeds.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Database.addMedication(Integer.valueOf(medIDfield.getText()), medsNameField.getText(),
							medsDoseField.getText());
					Database.updateComboBox(medicationComboBox, "medication");
				} catch (NumberFormatException e1) {
					JOptionPane.showMessageDialog(medicInputPanel, "Please enter an Valid ID", "Invalid ID",
							JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				} catch (SQLException e1) {
					e1.printStackTrace();
		...
		patInputPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 5), "Add Patient",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnaddPatient.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(patInputPanel, "Please enter an Valid ID/Age", "Invalid ID/Age",
							JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				} catch (SQLException e1) {
					e1.printStackTrace();
		...
		docInputPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 5), "Add Doctor",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnaddDoctor.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(docInputPanel, "Please enter an Valid ID", "Invalid ID",
							JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				} catch (SQLException e1) {
